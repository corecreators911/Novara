...
const SpecialityDetail = () => {
  ...
  return (
    <div className="flex flex-col bg-novara-bg">
      {/* Hero Section */}
      <section className="bg-white border-b border-novara-border">
        <div className="grid lg:grid-cols-2 min-h-[80vh] lg:min-h-[600px]">
          <div className="flex flex-col justify-center px-4 md:px-8 lg:px-16 xl:px-24 py-16 lg:py-0 order-2 lg:order-1 relative z-10 bg-white">
            {/* Breadcrumb */}
          ...
          <div className="order-1 lg:order-2 relative h-[40vh] lg:h-auto w-full">
            <img 
        ...
        <section className="py-16 md:py-24 bg-white border-y border-novara-border">
          <div className="container mx-auto px-4 md:px-6">
            <SectionHeader 
              ...
              align="center"
            />
            <div className="flex overflow-x-auto md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 pb-4 mt-12 snap-x snap-mandatory">
              {departmentDoctors.map((doc) => (
                <div 
                  key={doc.id}
                  className="min-w-[280px] md:min-w-0 snap-start bg-novara-bg rounded-xl border border-novara-border shadow-sm flex flex-col overflow-hidden"
                >
          ...
          <div className="container mx-auto px-4 md:px-6 max-w-3xl">
            ...
            <div className="space-y-6 mt-12">
              {speciality.faqs.map((faq, idx) => (
                <div key={idx} className="bg-white p-6 rounded-xl border border-novara-border shadow-sm">
